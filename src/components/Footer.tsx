    ...
    <footer className="bg-white py-12 border-gradient">
      ...
      <div className="container mx-auto px-4 mb-8">
        <nav className="flex justify-center gap-8 text-gray-600">
          <a href="#" className="hover:text-blue-600 transition-colors">SEARCH</a>
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center border-gradient pt-6">
          ...
          <div className="text-gray-600">
            © 2024, Personality Arc.
          </div>

          <div className="flex gap-4">
            <img src="/lovable-uploads/e4ec8030-d11b-4aa9-a86e-45dc26fd0b1a.png" alt="Payment Methods" className="h-8" />
          </div>
        </div>
      </div>
    </footer>
